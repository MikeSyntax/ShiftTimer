...
extension Date {
   ...
   //-------------Änderung von Wochenanfang = Sonntag zu Montag-----------------------------------------------------
    ...
    //-------------Monatsnamen als String zurückgeben---------------------------------------------------------------
    static var fullMonathNames: [String]{
    ...
    //-------------Der erste Tage im Monate ist nicht immer am Anfang-----------------------------------------------
    ...
    var calendarDisplayDays: [Date]{
        //aktueller Tage im Monat
        var days: [Date] = []
        for dayOffset in 0..<numberOfDaysInMonth {
            let newDay = Calendar.current.date(byAdding: .day, value: dayOffset, to: startOfMonth)
            days.append(newDay!)
        }
        //vergangene Tage im Monat
